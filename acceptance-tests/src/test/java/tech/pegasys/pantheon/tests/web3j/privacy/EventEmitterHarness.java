...
public class EventEmitterHarness {
  ...
  //            .keyPair(privacyNet.getNode(sender).pantheon.keyPair())
  ...
  //    condition.verify(privacyNet.getNode(nodeName).pantheon, transactionHash);
  //  }
}
